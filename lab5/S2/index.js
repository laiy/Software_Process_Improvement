window.onload = function() {
    ...
    atplusButton.addEventListener('click', sequenceRobotHandler);
};
...
var aHandler = function() {
    ...
    askForRandomNumberFromServer(button, disabledId, 'A');
};
...
var bHandler = function() {
    ...
    button.getElementsByTagName('span')[1].innerHTML = '...';
    var disabledId = disableButtonExcept(button);
    askForRandomNumberFromServer(button, disabledId, 'B');
};
...
var cHandler = function() {
    ...
    button.getElementsByTagName('span')[1].innerHTML = '...';
    var disabledId = disableButtonExcept(button);
    askForRandomNumberFromServer(button, disabledId, 'C');
};
...
var dHandler = function() {
    ...
    button.getElementsByTagName('span')[1].innerHTML = '...';
    var disabledId = disableButtonExcept(button);
    askForRandomNumberFromServer(button, disabledId, 'D');
};
...
var eHandler = function() {
    ...
    button.getElementsByTagName('span')[1].innerHTML = '...';
    var disabledId = disableButtonExcept(button);
    askForRandomNumberFromServer(button, disabledId, 'E');
};
...
var askForRandomNumberFromServer = function(button, disabledId, who) {
...
var sequenceRobotHandler = function() {
    var atplusButton = document.getElementsByClassName('apb')[0];
